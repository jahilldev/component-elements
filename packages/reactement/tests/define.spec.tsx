import React, { createElement, Fragment, ComponentFactory } from 'react';
...
describe('define()', () => {
  ...
  describe('when run in the browser', () => {
    ...
    it('wraps component in an HOC if provided', () => {
      ...
      const wrapComponent = (child: ComponentFactory<any, any>) => (props: any) =>
        createElement('section', {}, createElement(child, props));
  ...
  describe('when run on the server', () => {
    ...
    it('returns the correct markup', () => {
      ...
      const instance = shallow(createElement(component, props));
    ...
    //   const instance = shallow(createElement(component, props) as any);
